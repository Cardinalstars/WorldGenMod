package com.example.worldgenmod.client;
...
public class GeneratorModelLoader implements IModelLoader<GeneratorModelLoader.GeneratorModelGeometry> {
    ...
    public static final ResourceLocation GENERATOR_LOADER = new ResourceLocation(WorldGenMod.MODID, "generatorloader");

    public static final ResourceLocation GENERATOR_FRONT_POWERED = new ResourceLocation(WorldGenMod.MODID, "block/generator_front_powered");
    public static final ResourceLocation GENERATOR_FRONT = new ResourceLocation(WorldGenMod.MODID, "block/generator_front");
    public static final ResourceLocation GENERATOR_SIDE = new ResourceLocation(WorldGenMod.MODID, "block/generator_side");
    public static final ResourceLocation GENERATOR_ON = new ResourceLocation(WorldGenMod.MODID, "block/generator_on");
    public static final ResourceLocation GENERATOR_OFF = new ResourceLocation(WorldGenMod.MODID, "block/generator_off");
